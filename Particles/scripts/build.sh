...
# ============================================================
# Build script for ParticlesSimulation
# ============================================================
...
echo "============================================================"
echo "ParticlesSimulation build"
echo "============================================================"
...
find "${BUILD_DIR}" \
    ...
    -type f \
    -perm -111 \
    \( -name "particles_omp" -o -name "particles_cuda" \) \
    -print || true
...
echo
echo "Run examples:"
echo "  ./build/particles_omp  input/Particles.inp output/Particles_cpp.h5"
echo "  ./build/particles_cuda input/Particles.inp output/Particles_cuda.h5"
echo "============================================================"
