...
#
# Optional:
# - hdf5: used if PARTICLES_BUILD_HDF5=AUTO and CMake finds it
# - libomp: used if PARTICLES_BUILD_OPENMP=AUTO and CMake finds it
...
if brew list hdf5 >/dev/null 2>&1; then
    ...
    echo "[WARN] The macos-arm64 preset uses PARTICLES_BUILD_HDF5=AUTO,"
